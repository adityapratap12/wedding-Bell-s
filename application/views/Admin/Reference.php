     ...
     <!-- general form elements -->
            <div class="card card-info" align="left">
              <div class="card-header">
                <h3 class="card-title">References Record Table</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

  <form method="post" action="<?php echo base_url().'Admin/Reference/Add'?>" enctype="multipart/form-data">
                <div class="card-body">

              

                  <div class="form-group">
                    <label for="exampleInputEmail1">Select Reference</label>
                    <select class="form-control" name="ref">
                        
                              <option value="1">Social Website</option>
                              <option value="2">News Paper</option>
                              <option value="3">Friends</option>
                              <option value="4">TV Ads</option>
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Reference Name" name="name">
                ...
                <div class="card-footer" align="center">
                    ...
                    <input type='submit' name="upload" class="btn btn-info" value='Create Reference'/>
                </div>
              </form>
            </div>
            <!-- /.card -->
