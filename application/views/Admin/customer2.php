...
<div class="wrapper">
 ...
 <div class="col-sm-8">
  ...
  <form method="post" action="<?php echo base_url().'Admin/Rough/AddCustomer'?>" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Name of the Customer" name="name" required="">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="E-Mail Address" name="email">
             
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">Address</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Full Address of Customer" name="address">
                ...
                <div class="card-footer" align="center">
                    ...
                    <input type='submit' name="upload" class="btn btn-info" value='Create Customer'/>
                </div>
              </form>
            </div>
            <!-- /.card -->
