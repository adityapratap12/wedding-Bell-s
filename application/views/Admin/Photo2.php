     ...
     <!-- general form elements -->
            <div class="card card-info" align="left">
              <div class="card-header">
                <h3 class="card-title">Upload Photo in Gallery</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

  <form method="post" action="<?php echo base_url().'Admin/Photo2/AddPhoto'?>" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="card-footer" align="center">
                    ...
                    <input type='submit' name="upload" class="btn btn-info" value='Upload Photo'/>
                </div>
              </form>
              <div align="right">
                <a href="<?php echo base_url();?>Admin/Album/View_Album" class="btn btn-danger">Back to Album</a> </div>
            </div>
            <!-- /.card -->
          </div>
        </center>
