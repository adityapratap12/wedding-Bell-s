 ...
 <div class="col-sm-6">
    ...
    <div class="card card-info">
              ...
              <!-- form start -->
               ...
               <form class="form-horizontal" action="<?php echo base_url().'Admin/Home/Updatepassword'?>" method="post">
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info toastrDefaultInfo" name="update">Update Password</button>
...
<script type="text/javascript">
  $(function() {
    ...
    $('.toastrDefaultInfo').click(function() {
      toastr.info('Successfully Updated your Password')
    });
    $('.toastrDefaultError').click(function() {
      toastr.error('Business Plan has been Successfully Deleted')
    });
