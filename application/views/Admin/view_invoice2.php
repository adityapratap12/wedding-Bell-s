  ...
  ?>
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">List of Customer Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
   ...
   <?php  
         ...
         {?>  
           ...
           $sqli = "SELECT * FROM trans2 where cid='$row->id'";
                    $result = mysqli_query($con,$sqli);
                    while($rows = mysqli_fetch_assoc($result)){
                      $amount=$amount+$rows['amount'];
                    }

                      $sqli2 = "SELECT * FROM transaction2 where cid='$row->id'";
                    $result2 = mysqli_query($con,$sqli2);
                    while($rows2 = mysqli_fetch_assoc($result2)){
                      $paid=$paid+$rows2['amount'];
                    }
                    ...
                    <td>
       <a href="Invoice?id=<?php echo $row->id;?>" class="btn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-stn btn-success" target="_blank">Pay</a>
        <a href="Print_Invoice?id=<?php echo $row->id;?>" class="btn btn-info" target="_blank">Invoice</a>
