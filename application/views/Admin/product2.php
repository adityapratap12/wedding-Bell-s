...
?>
  <form method="post" action="<?php echo base_url().'Admin/Rough/AddProduct'?>" enctype="multipart/form-data">
                <div class="card-body">
    ...
    ?>
     ...
     <!-- general form elements -->
            <div class="card card-info" align="left">
              ...
              <!-- /.card-header -->
              <!-- form start -->
  <form method="post" action="<?php echo base_url().'Admin/Rough/AddPayment'?>" enctype="multipart/form-data">
                <div class="card-body">

                   <div class="form-group">
                    <label for="exampleInputEmail1">Amount</label>
                    <input type="text" class="form-control" name="amt" value="<?php echo $amount;?>">
                    <input type="hidden" class="form-control" name="cid" value="<?php echo $id;?>">
