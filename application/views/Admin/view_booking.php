  ...
  ?>
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">List of Booking Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  <?php  
         ...
         {?>  
                ...
                <tr>
                  ...
                  <td><?php echo $row->expart;?></td>
                  <td><?php echo $row->ddate;?></td>
                  <td><?php echo $row->msg;?></td>
                    <td width="200">
       <a href="Deletedata?id=<?php echo $row->id;?>" class="btn btn-danger toastrDefaultError">Delete</a>
      <a href="Updatedata?id=<?php echo $row->id;?>" class="btn btn-info">Confirm</a>
