     ...
     <!-- general form elements -->
            <div class="card card-info" align="left">
              <div class="card-header">
                <h3 class="card-title">Video Record Table</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

  <form method="post" action="<?php echo base_url().'Admin/Video/AddVideo'?>" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Youtube URL" name="des">
                ...
                <div class="card-footer" align="center">
                    ...
                    <input type='submit' name="upload" class="btn btn-info" value='Upload Video'/>
                </div>
              </form>
            </div>
            <!-- /.card -->
