  ...
  ?>
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">List of Member's Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tr>
                  ...
                  <td><?php echo $row->name;?></td>
                   ...
                   <td><?php echo $row->fname;?></td>
                    ...
                    <td>
       <a href="Deletedata?id=<?php echo $row->id;?>" class="btn btn-danger">X</a>
       <a href="viewdata?id=<?php echo $row->id;?>" class="btn btn-success" target="_blank">Details</a>
