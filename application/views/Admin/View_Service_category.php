  ...
  ?>
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">List of Services Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  $co=0;  
         ...
         { $co=$co+1;
          ?>  
                ...
                <tr>
                  <td><?php echo $co;?></td>
                  <td><a href="<?php echo $row->image;?>"><img src="<?php echo $row->image;?>" width="60px" height="50px"></a></td>
                  <td><?php echo $row->title;?></td>
     
                  
             
                    <td>
       <a href="Deletedata_photo?id=<?php echo $row->id;?>" class="btn btn-danger">X</a>
