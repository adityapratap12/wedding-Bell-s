 ...
 <?php  
      ...
      foreach ($data as $row4) {
            ...
            ?> 
                        ...
                        <td><?php echo $row4->famt;?> <span>&#8377;</span> on <?php echo $row4->ddate;?> by <?php echo $row4->mode;?></td>
                      </tr>
                     <?php } ?>
                    </table>
                  </div>
           ...
           <?php 
            ...
            $amount=$amt-(($amt*$dis)/100);
            $percent=18;
            $paid=0;
           
            $exgst=($amt-(($amt*$dis)/100))/100;
  ...
  $withoutgst=$amount-$gst_amount;
      ...
      $total=($amt+$exgst)-$paid;
            ?> 

                        <th style="width:50%">Price:</th>
                        <td><?php echo $amt;?> <span>&#8377;</span></td>
                      </tr>
                        <tr>
                        <th>Discount:</th>
                        <td><?php echo round(($amt*$dis)/100);?> <span>&#8377;</span> (<?php echo $dis;?>%)</td>
                      </tr>

                          <tr>
                        <th>Subtotal:</th>
                        <td><?php echo round($sub=$amt-(($amt*$dis)/100));?><span>&#8377;</span></td>
                      </tr>

                      <tr>
                        <th>GSTIN (09ABPFM0580P1ZH)</th>
                        <td><?php echo round($t=(($amt-(($amt*$dis)/100))*18)/100);?> <span>&#8377;</span> (18%)</td>
                      </tr>
                      <tr>
                        <th>Total:</th>
                        <td><?php echo round($tt=$t+$sub);?> <span>&#8377;</span></td>
                      </tr>
                         ...
                         <tr>
                        <th>Paid:</th>
                        <td><?php echo $paid;?> <span>&#8377;</span></td>
                      </tr>
                         <tr>
                        <th>Due Amount:</th>
                        <td><?php echo round($tt-$paid);?> <span>&#8377;</span></td>
                      </tr>
                    </table>
                  </div>
                </div>
