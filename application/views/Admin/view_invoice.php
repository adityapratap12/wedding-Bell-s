 ...
 <?php include 'Sidebar.php';?>
  ...
  <?php  
         ...
         {?>  
           ...
           $sqli = "SELECT * FROM trans where cid='$row->id'";
                    ...
                    while($rows = mysqli_fetch_assoc($result)){
                      ...
                      $cc=0;
                      $dis=0;
                      $sqli2 = "SELECT * FROM transaction where cid='$row->id'";
                    ...
                    while($rows2 = mysqli_fetch_assoc($result2)){
                      ...
                      $dis=$rows2['dis']; 
                        ...
                        $cc=1;
                      $paid=$paid+$rows2['famt'];
                    }
                    $sub=round($amount-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amot-(($amount*$dis)/100));
                    $wgst=round($sub+($sub*18)/100);
                    echo $dues=round($wgst-$paid);
                      ?>
                    &#8377;
                    </td>
             
                    <td>
       <a href="Invoice?id=<?php echo $row->id;?>" class="btn btn-success" target="_blank">Pay</a>
