     ...
     <!-- general form elements -->
            <div class="card card-info" align="left">
              <div class="card-header">
                <h3 class="card-title">Album Record Table</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

  <form method="post" action="<?php echo base_url().'Admin/Album/AddAlbum'?>" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Title of the News" name="title" required="">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Details of Event" name="des">
               
                  </div>

                      <div class="form-group">
                    <label for="exampleInputPassword1">Date of Album</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Exp : DD (01)" name="dd">
               
                  </div>

                       <div class="form-group">
                    <label for="exampleInputPassword1">Month of Album</label>
                   <select class="form-control" name="mm">
                     ...
                     <option>DEC</option>
                       ...
                       <div class="form-group">
                    <label for="exampleInputPassword1">Year of Album</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Exp : YYYY (2022)" name="yy">
                ...
                <div class="card-footer" align="center">
                    ...
                    <input type='submit' name="upload" class="btn btn-info" value='Create Album'/>
                </div>
              </form>
            </div>
            <!-- /.card -->
