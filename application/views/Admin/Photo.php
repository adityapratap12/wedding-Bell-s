...
<div class="wrapper">
 ...
 <div class="col-sm-8">
  ...
  <form method="post" action="<?php echo base_url().'Admin/Photo/AddPhoto'?>" enctype="multipart/form-data">
                <div class="card-body">
                
      <div class="form-group">
                    <label for="exampleInputEmail1">Product Name</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Exp : Product Name" name="title" required="">
             
                  </div>

                    <div class="form-group">
                    <label for="exampleInputEmail1">Product Description</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Exp : This is Product Details" name="des" required="">
                ...
                <div class="card-footer" align="center">
                    ...
                    <input type='submit' name="upload" class="btn btn-info" value='Click here to Add Product'/>
                </div>
              </form>
              <div align="right">
                <a href="<?php echo base_url();?>Admin/Event/View_Event" class="btn btn-danger">Back to Category</a> </div>
            </div>
            <!-- /.card -->
          </div>
        </center>
