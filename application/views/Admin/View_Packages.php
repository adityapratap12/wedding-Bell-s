...
<div class="wrapper">
 ...
 <?php include 'Sidebar.php';?>
  ...
  ?>
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">List of Package Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  $co=0;
       ...
       <a href="AddPhoto?id=<?php echo $row->id;?>" class="btn btn-info">Add Package</a>
 
                   
       <a href="ViewPhoto?id=<?php echo $row->id;?>" class="btn btn-success">View Package</a>
        <a href="Deletedata?id=<?php echo $row->id;?>" class="btn btn-danger">Delete Package</a>
   <?php } ?>
