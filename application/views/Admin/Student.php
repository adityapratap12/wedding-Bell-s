...
<div class="wrapper">
 ...
 <div class="col-sm-8">
  ...
  <form method="post" action="<?php echo base_url().'Admin/Student/AddStudent'?>" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Name of the Student" name="name" required="">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Class of the Student" name="desi">
                ...
                <div class="card-footer" align="center">
                    ...
                    <input type='submit' name="upload" class="btn btn-info" value='Create Student'/>
                </div>
              </form>
            </div>
            <!-- /.card -->
