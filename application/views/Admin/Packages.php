     ...
     <!-- general form elements -->
            <div class="card card-info" align="left">
              <div class="card-header">
                <h3 class="card-title">Package Record Table</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

  <form method="post" action="<?php echo base_url().'Admin/Package_C/AddPackage'?>" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Package Name" name="title" required="">
             
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Package Details</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Package Details" name="des" required="">
