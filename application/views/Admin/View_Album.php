...
<div class="wrapper">
 ...
 <?php include 'Sidebar.php';?>
  ...
  ?>
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">List of Album Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  $co=0;
         foreach ($data as $row)  
         {
          ...
          ?>  
               ...
               <td><?php echo $co;?></td>
                  ...
                  <td><?php echo $row->dd;?>/<?php echo $row->mm;?>/<?php echo $row->yyyy;?></td>
       ...
       <a href="AddPhoto?id=<?php echo $row->id;?>" class="btn btn-info">Add</a>
 
                   
       <a href="ViewPhoto?id=<?php echo $row->id;?>" class="btn btn-success">View</a>
        <a href="Deletedata?id=<?php echo $row->id;?>" class="btn btn-danger">Delete</a>
   <?php } ?>
