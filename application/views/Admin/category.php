...
<div class="wrapper">
 ...
 <div class="col-sm-8">
  ...
  <form method="post" action="<?php echo base_url().'Admin/Categorys/AddCategory'?>" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Category Title" name="title" required="">
             
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Details</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Details of Category" name="des" required="">
                ...
                <div class="card-footer" align="center">
                    ...
                    <input type='submit' name="upload" class="btn btn-info" value='Click here'/>
                </div>
              </form>
            </div>
            <!-- /.card -->
