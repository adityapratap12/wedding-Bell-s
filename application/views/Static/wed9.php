            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed9">Kashmiri Wedding</a></li>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/9.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Kashmiri Wedding</h1>
                                <p class="lead" align="justify">Kashmiri weddings are very similar to Hindu weddings. In Kashmiri weddings, a ceremony called ‘Diugun’ is performed which is similar to the ‘Haldihanth Rasam’. When the groom and his family arrives, both the fathers of the couple exchange nutmeg as a symbol of their friendship.</p>
                            </div>
                        </div>
