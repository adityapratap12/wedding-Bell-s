            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed3">Assamese Wedding</a></li>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/3.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Assamese Wedding</h1>
                                <p class="lead" align="justify">On the day of the wedding, a bathing custom is followed in Assamese wedding in which the bride and groom’s mother visit the nearby river to fetch holy water for the bath. In Assamese wedding, the feast or the reception part is held prior to the marriage ceremony. Earlier curd, rice, and jaggery were served to the guests but now a lavish reception party is hosted in which mouth-watering dishes are served.</p>
                            </div>
                        </div>
