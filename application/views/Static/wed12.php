            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed12">Muslim Wedding</a></li>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/12.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Muslim Wedding</h1>
                                <p class="lead" align="justify">Nikah in Islam is read by two priests and after the consent of the couple, the pious Nikah Naama is signed. Hereafter, the assembly is addressed with Khutba-tun-nikah or the marriage sermon. After this sermon, a mirror is placed between the couple, where their eyes meet each other for the first time.</p>
                            </div>
                        </div>
