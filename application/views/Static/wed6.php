        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <ol class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li class="active">About Wedding</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed6">Kannada Wedding</a></li>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/6.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Kannada Wedding</h1>
                                <p class="lead" align="justify">During the auspicious time of the wedding, the bride is brought to be seated at the mandap by her sisters. The face of the bride is covered with a fan made out of peacock feathers. Afterward, the parents of the bride give away their daughters by performing a ritual called ‘Dhare Herdu’ followed by ‘Satapadi’ which is completed by taking seven circles of the holy fire.</p>
                            </div>
                        </div>
