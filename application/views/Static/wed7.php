            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed7">Gujrati Wedding</a></li>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/7.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Gujrati Wedding</h1>
                                <p class="lead" align="justify">The wedding affair starts with exchanging Jaimaala’s twice. Unlike other Hindu weddings, Gujrati’s take four Pheras which are called as Mangal Pheras. During Mangal Pheras, the couple circles the holy fire four times which symbolizes ‘Dharma’, ‘Artha’, ‘Kama’ and ‘Moksha’.</p>
                            </div>
                        </div>
