            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed13">Pahari Wedding</a></li>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/13.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Pahari Wedding</h1>
                                <p class="lead" align="justify">On the day of the wedding, a ceremony called Dhulyaraj is performed in which the groom is received. The bride wears a traditional dupatta called ‘Pichorra’ and gets ready for the pheras, which is followed by vidai.</p>
                            </div>
                        </div>
