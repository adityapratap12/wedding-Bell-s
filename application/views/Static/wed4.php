            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed4">Buddhist Wedding</a></li>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/4.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Buddhist Wedding</h1>
                                <p class="lead" align="justify">Since Buddhism is based on leading a simple life, their weddings are also simple and have a low-key affair. There are no mandatory rules and regulations to be followed in a Buddhist wedding. The couples get married in a Buddhist temple, licensed as a legal marriage venue.</p>
                            </div>
                        </div>
