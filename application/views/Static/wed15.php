            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed15">Sikh Wedding</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/15.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Sikh Wedding</h1>
                                <p class="lead" align="justify">A Sikh wedding is similar to a Punjabi wedding. The only difference being that it takes place during the day in Gurudwara, where the ardaas are recited.</p>
                            </div>
                        </div>
