        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    ...
                    <h1>About Maharashtrian Wedding</h1>
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed10">Maharashtrian Wedding</a></li>
