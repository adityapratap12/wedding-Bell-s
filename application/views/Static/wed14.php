            ...
            <div class="row">
                    ...
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                              <li><a href="<?php echo base_url();?>Welcome/wed">Hindu Wedding</a></li>
                                    ...
                                    <li class="active"><a href="<?php echo base_url();?>Welcome/wed14">Punjabi Wedding</a></li>
                ...
                <div class="col-md-9 content-right">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                            <img src="<?php echo base_url();?>Public/Static/images/WP/14.jpg" alt="" class="col-md-12"> 
                        </div>

                            <div class="aboutus" id="aboutus">
                                
                                <h1>Punjabi Wedding</h1>
                                <p class="lead" align="justify">On the wedding day, the bride receives a ‘chuda, the white and red coloured bangles from her maternal uncle or mama. Followed by this ritual, the Ghara Ghardoli ceremony takes place in which the bride and groom are bathed in the holy water brought from the Gurudwara. On the wedding night, the couple exchange garlands and are taken to the mandap to perform other marriage rituals.</p>
                            </div>
                        </div>
