...
<html>
<head>
<title>SAV MultiTech Solution (E-Mail)</title>
<!-- Custom Theme files -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="SAV" />
<!-- //Custom Theme files -->
									...
									<td>
										<table border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="logo">
											<tbody>
												...
												<tr>
													<td align="right">
	<a href="#" class="logo-text" style="text-decoration:none;"><img src="https://savmultitechsolution.com/Public/Email/img/logo1.png" alt=" " width="400" height="80"></a>
													</td>
												</tr>
											</tbody>
										</table>		
				...
				<a href="mailto:info@savmultitechsolution.com" style="color:#fff;text-decoration:none"><img src="https://savmultitechsolution.com/Public/Email/img/envelope.png" alt="" border="0" height="18" width="18">&nbsp; &nbsp;info@savmultitechsolution.com</a>
																	</td>
																</tr>
															</tbody>
														</table>
														<table class="mail_right" align="right" border="0" cellpadding="0" cellspacing="0" width="150">
															<tbody>
																<tr>			
		<td align="center"  style="font-size:14px;color:#f5f5f5;font-family:Arial,serif"><img src="https://savmultitechsolution.com/Public/Email/img/1.png" alt="" border="0" height="16" width="16">&nbsp; &nbsp;+91 7268 839 994</td>
																</tr>
															</tbody>
														</table>
													</td>
					...
					<tr>
						<td>
							<table class="ban-hei" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background:url(https://savmultitechsolution.com/Public/Email/img/ban1.jpg); background-size:cover;" height="380">	
								<tbody>
									<tr>
														...
														<td>				
															<table class="ban_info" border="0" cellpadding="0" cellspacing="0"  width="500">				
																<tbody>
																	...
																	<tr>
			<td class="future" style="font-size:2.3em;color:white;text-transform:capitalize;font-family:Candara;text-align:center;line-height:1.5em"><b>Welcome<br> <?php echo $name;?> (<?php echo $regid;?>)</b></td>
																	</tr>	
									...
									<tr>
										<td style="font-size:1.3em;color:yellow;text-transform:capitalize;font-family:Candara;text-align:center">
											<b>Thanks for connected with us...</b>
										</td>
									</tr>
									<tr>
										<td class="ban_pad" height="80"></td>
